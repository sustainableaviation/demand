...
# Get connection data
file_path = os.path.join(parent_directory, "Airport Data/flight_connections.json")
...
fig = go.Figure(go.Scattergeo(
    ...
    marker=dict(
        ...
        colorbar_title="Average Daily<br>Departing Flights<br>Jan. 2024"
    )
))
...
pdf_file_path = os.path.join(current_directory, "Air_Traffic_Worldmap_month.pdf")
