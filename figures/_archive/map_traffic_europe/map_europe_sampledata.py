...
path_geodata = Path("../../_geodata")
countries = gpd.read_file(path_geodata / 'ne_10m_admin_0_countries/ne_10m_admin_0_countries.shp')
graticules = gpd.read_file(path_geodata / 'ne_50m_graticules_10/ne_50m_graticules_10.shp')
...
geodf_airports = import_airports_csv('data/airports.csv')


airport_connections = pd.read_csv(
    filepath_or_buffer='data/connections.csv',
    sep=';',
    header='infer',
)
