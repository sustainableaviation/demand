...
proposed_route = gpd.read_file('data/proposed_routes/Australia_real.shp')
proposed_route = proposed_route.set_crs('EPSG:4326') # = WGS 84

# https://stackoverflow.com/a/72266527/
path_calculated_route = Path('./data/routes_detailed_slopes/Australia')
...
target_projection = "EPSG:5825" # https://epsg.io/102599
