...
calculated_route = gpd.read_file('data/Routes_noSlopes/Nigeria.shp')

# GEOGRAPHY SETUP ###############################

# https://geopandas.org/en/stable/docs/reference/api/geopandas.GeoDataFrame.set_crs.html
target_projection = "ESRI:102022" # https://epsg.io/26392
...
"""
# oceans inverted after projection transformation
# https://stackoverflow.com/questions/78536561
oceans.plot(
    ax = ax,
    color = 'lightblue',
    alpha = 1,
